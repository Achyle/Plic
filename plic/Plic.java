...
public class Plic {
	...
	public static final String USAGE_CLASS = "classe {idf} {declaration}* fin";
	public static final String USAGE_ECRIRE = "ecrire {expression}|{chaine} ;";
	public static final String USAGE_ECRIRE_CHAINE = "ecrire {chaine} ;";
	public static final String USAGE_LIRE = "lire {idf} ;";
	public static final String USAGE_EXP_ENTIERE = "{expression entiere}";
	public static final String USAGE_EXP_BOOLEEN = "{expression booleen}";
	public static final String USAGE_EXP_PARENTHESE = "({expression})";
	public static final String USAGE_DECL_CHAMP = "{status} {type} {idf} [,{idf}]* ;";
	public static final String USAGE_AFFECT = "{idf} = {expression entiere} ;";
